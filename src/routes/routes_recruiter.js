...
// const DashboardCoreUI = React.lazy(() => import("./views/Dashboard"));
...
const Acquisition = React.lazy(() =>
  import("../components/Admin/Acquisition funnel/Acquisition funnel")
);

const Vacancy_dashboard = React.lazy(() =>
  import("../components/Admin/Vacancy dashboard/Dashboard")
);

const Dashboard_canban = React.lazy(() =>
  import("../components/Admin/Vacancy dashboard/Canban")
);
...
const routes = [
  { path: "/", name: "Home", component: Vacancy_dashboard, exact: true },
  // {
  ...
  // },
  // { path: "/charts", name: "Charts", component: Charts }, // прототип
  ...
  { path: "/acquisition", exact: true, name: "Acquisition funnel", component: Acquisition },
  { path: "/dashboard", exact: true, name: "Dashboard", component: Vacancy_dashboard },
  { path: "/canban", exact: true, name: "Canban", component: Dashboard_canban }
];
